...
extern volatile uint8_t firmwareVersionMajor;
extern volatile uint8_t firmwareVersionMinor;
extern volatile uint32_t firmwareVersionHash;
extern volatile uint8_t catInterfaceVersionMajor;
extern volatile uint8_t catInterfaceVersionMinor;
extern volatile uint32_t catInterfaceVersionHash;
extern volatile uint8_t hardwareVersionMajor;
extern volatile uint8_t hardwareVersionMinor;
